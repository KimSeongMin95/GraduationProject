// PCH for H:\Program Files (x86)\UE_4.23\Engine\Source\Runtime\Engine\Public\EngineSharedPCH.h
#define IS_PROGRAM 0
#define UE_EDITOR 1
...
#include "H:/Program Files (x86)/UE_4.23/Engine/Source/Runtime/Engine/Public/EngineSharedPCH.h"

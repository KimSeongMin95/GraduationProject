...
void AOnlineGameMode::Tick(float DeltaTime)
{
	...
	TickOfGameServer(DeltaTime);
	TickOfGameClient(DeltaTime);

	CheckDefeatCondition(DeltaTime);
}

void AOnlineGameMode::TickOfGameServer(float DeltaTime)
{
...
void AOnlineGameMode::TickOfGameClient(float DeltaTime)
{

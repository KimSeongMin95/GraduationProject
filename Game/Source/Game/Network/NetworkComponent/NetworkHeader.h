...
* Current Affiliation(2020-11-27): 홍익대학교 세종캠퍼스 게임소프트웨어 전공 4학년
* NetworkComponent: IOCP API를 사용하여 직접 개발한 TCP 네트워크 엔진입니다.
...
#pragma comment(lib, "ws2_32.lib") // winsock2 사용을 위해 코멘트를 추가합니다.

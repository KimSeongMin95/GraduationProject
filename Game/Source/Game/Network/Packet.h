...
enum EPacketType
{
	...
	MODIFY_WAITING_ROOM,  // 방장이 대기방에서 Title이나 Stage나 MaxOfNum을 변경할 때: 방장을 제외한 대기방인 플레이어들에게 브로드캐스팅 해야 함.
	JOIN_WAITING_ROOM,	  // 어떤 플레이어가 대기방에 들어올 때: 대기방인 플레이어들에게 브로드캐스팅 해야 함.
	PLAYER_JOINED_WAITING_ROOM, // dd

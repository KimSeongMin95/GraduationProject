...
AGrenadeLauncher::AGrenadeLauncher()
{
	...
	static ConstructorHelpers::FObjectFinder<USkeletalMesh> skeletalMeshAsset(TEXT("SkeletalMesh'/Game/SciFiWeapLight/Weapons/White_GrenadeLauncher.White_GrenadeLauncher'"));
	...
	static ConstructorHelpers::FObjectFinder<USkeleton> skeleton(TEXT("Skeleton'/Game/SciFiWeapLight/Weapons/White_GrenadeLauncher_Skeleton.White_GrenadeLauncher_Skeleton'"));
	...
	// 총 쏘는 애니메이션을 가져와서 적용
	static ConstructorHelpers::FObjectFinder<UAnimSequence> animSequence(TEXT("AnimSequence'/Game/SciFiWeapLight/Weapons/Anims/Fire_GrenadeLauncher_W.Fire_GrenadeLauncher_W'"));
